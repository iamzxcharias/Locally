...
INSERT INTO events (id, title, category, description, starts_at, place_name, lat, lng, creator_id, participant_count)
VALUES ('eeeeeeee-1111-1111-1111-eeeeeeeeeeee', 'Locally Tech Meetup', 'TECH', 'Networking für Entwickler', '2026-06-01 18:00:00', 'Coworking Space', 48.1351, 11.5820, '11111111-1111-1111-1111-111111111111', 0);

INSERT INTO events (id, title, category, description, starts_at, place_name, lat, lng, creator_id, participant_count)
VALUES ('eeeeeeee-2222-2222-2222-eeeeeeeeeeee', 'Pizza Party', 'SOCIAL', 'Essen und Trinken für alle', '2026-07-15 19:30:00', 'Bobs Garten', 48.1400, 11.5900, '22222222-2222-2222-2222-222222222222', 1);
